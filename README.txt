...
We also implement another method for approximation denoted as DC, which applies Don't Care signals to the Least Significant Bits (LSBs) of the comparators.
